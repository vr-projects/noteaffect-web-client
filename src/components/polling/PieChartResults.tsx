...
interface IPieChartResultsProps {
  results: IPollingResults;
  autoFit?: boolean;
}

interface IPieChartResultsState {}

export default class PieChartResults extends SrUiComponent<
  IPieChartResultsProps,
  IPieChartResultsState
> {
